...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ISUCCaSY#Euq_r3bL72Stz9CDNN3or7kJfToEiMgLskJWAOIk1sU",
    CUSTOM_REACT: process.env.CUSTOM_REACT || "false",
    CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🔥,❤️‍🩹,❤️,🩷,🧡,💛,💚,💙,🩵,💜,🤎,🖤,🩶,🤍",
    CAPTION: process.env.CAPTION || "*ᴘᴏᴡᴅᴇʀᴇᴅ ʙʏ 𝚁𝙰𝚅𝙸𝙽𝙳𝚄*",
    ...
    AUTHOR: (process.env.PACK_INFO?.split(';') || [])[0] || 'Raviya_AWAIS MD',
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'M AWAIS-MD WHATSAPP BOT Powered by Ravindu Lakshith😊♻️",
    ...
    BOT_NAME: process.env.BOT_NAME || "Raviya_ᴀᴡᴀɪs ᴍᴅ",
